...
<div class="bg-base-200 text-base-content flex min-h-full flex-col gap-1 p-2">
	...
	<div class="flex flex-row place-items-center items-center justify-center gap-2 px-2 pt-4 pb-4">
